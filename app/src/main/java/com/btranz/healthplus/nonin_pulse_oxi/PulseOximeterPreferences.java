 ...
 */
public class PulseOximeterPreferences extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		actionBar.setTitle(R.string.title_activity_pulse_oximeter_settings);
	...
	public static class PrefsFragment extends PreferenceFragment {
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			if(pref!=null) {
				pref.setSummary("Add device preferences");
			}
