...
public class MainActivity extends ActionBarActivity implements FragmentDrawer.FragmentDrawerListener {
    ...
    String ttitles[]={"farhan","shoaib","abbu"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* ttitles = getApplicationContext().getResources().getStringArray(R.array.nav_drawer_labels);
        ICONS=getApplicationContext().getResources().getIntArray(R.array.navDrawerIcons);*/
