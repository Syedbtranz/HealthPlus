...
// Alive Technologies
package com.btranz.healthplus.alive_ecg;
...
import com.btranz.healthplus.alive_ecg.aliveclasses.HRDet;
import com.btranz.healthplus.alive_ecg.HeartMonitorListener.HeartMonitorStatus;
            ...
            while(!mmCancel) {
		    		...
		    		if(!mmCancel && tmpInStream!=null) {
		    			...
		    			try {
                            ...
                            if (MonitoringActivity.bpSyncLatch != null)
                            {
                                ...
                                MonitoringActivity.bpSyncLatch = null;
                            }
        		...
        		if(!mmCancel) {
        			...
        			try {
        				...
        				int count=0;
                        if (reconnectAttempts > 1) //attempt to reconnect 1 time
                            stopConnection();
                        reconnectAttempts++;
