...
// Alive Technologies
package drawable.qardioarm_blood_pressure;
...
import com.btranz.healthplus.qardioarm_blood_pressure.BloodPressureCuffListener.BloodPressureCuffStatus;
...
public class BloodPressureCuff {
    ...
    private BloodPressureCuffListener mListener;

    public BloodPressureCuff(BloodPressureCuffListener listener, String btAddress) {
       mListener =  listener;
    ...
    private class ConnectionThread extends Thread {
        ...
        public void run() {
            BloodPressureCuffPacket hmPacket = new BloodPressureCuffPacket();
            ...
            while(mmCancel==false) {
	            ...
	            if(mmCancel==false && mmSocket.isConnected()) {
		    		...
		    		if(mmCancel==false && tmpInStream!=null) {
		    			...
		    			mListener.onAliveStatus(BloodPressureCuffStatus.BPC_STATUS_CONNECTED);
				            ...
				            while (!mmCancel) {
				                ...
				                for (int n = 0; n < nBytesRead; n++) {
				                    if (hmPacket.add(streamBuffer[n])) {
				                        ...
				                        mListener.onPulseOxiPacket(sampleCount, hmPacket);
        		...
        		if(!mmCancel) {
        			mListener.onAliveStatus(BloodPressureCuffStatus.BPC_STATUS_RECONNECTING);
        			try {
    ...
    public synchronized void stopConnection() {
    	...
    	mListener.onAliveStatus(BloodPressureCuffStatus.BPC_STATUS_NONE);
    }
    public synchronized void startConnection()
    {
        ...
        mListener.onAliveStatus(BloodPressureCuffStatus.BPC_STATUS_CONNECTING);
    }
